import 'package:WorkoutClock/EMOM/Emom_Top_Display/Emom_text/Emom_setup_text.dart';
...
class EmomInitialDisplay extends StatelessWidget {
  const EmomInitialDisplay({super.key});
