...
class TabataInProgressDisplay extends StatelessWidget {
  TabataInProgressDisplay({super.key, required this.state});
              ...
              child: Stack(
                ...
                children: [
                  TweenAnimationBuilder(
                      tween: Tween(begin: 1, end: state.interval / ( (state.tabataModel.interval)) ),
                  ...
                  Positioned(
                    top: 50,
                    child: Text('Work', style: GoogleFonts.bebasNeue(
                      fontSize: 30,
                      color: Colors.white,
                    ),),
                  ),
